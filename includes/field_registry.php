    ...
    public static function all(): array
    {
        return [
            ...
            'vegetarian_label' => [
                ...
                'group'                      => self::GROUP_CLAIMS,
                'option_key'                 => 'enable_vegetarian_label_field',
                'meta_key'                   => '_lotzwoo_vegetarian_label',
                'shortcode'                  => 'lotzwoo_vegetarian_label',
                'heading_option_key'         => 'heading_vegetarian_label_field',
                'field_type'                 => 'checkbox',
                'settings_label'             => __('Als vegetarisch kennzeichnen', 'lotzapp-for-woocommerce'),
                'settings_description'       => __('Blendet ein Ja/Nein-Vegetarisch-Label ein.', 'lotzapp-for-woocommerce'),
                'product_field_label'        => __('Als vegetarisch kennzeichnen', 'lotzapp-for-woocommerce'),
            ...
            'glutenfree_label' => [
                ...
                'group'                      => self::GROUP_CLAIMS,
                'option_key'                 => 'enable_glutenfree_label_field',
                'meta_key'                   => '_lotzwoo_glutenfree_label',
                'shortcode'                  => 'lotzwoo_glutenfree_label',
                'heading_option_key'         => 'heading_glutenfree_label_field',
                'field_type'                 => 'checkbox',
                'settings_label'             => __('Als glutenfrei kennzeichnen', 'lotzapp-for-woocommerce'),
                'settings_description'       => __('Blendet ein Ja/Nein-Glutenfrei-Label ein.', 'lotzapp-for-woocommerce'),
                'product_field_label'        => __('Als glutenfrei kennzeichnen', 'lotzapp-for-woocommerce'),
            ...
            'lactosefree_label' => [
                ...
                'group'                      => self::GROUP_CLAIMS,
                'option_key'                 => 'enable_lactosefree_label_field',
                'meta_key'                   => '_lotzwoo_lactosefree_label',
                'shortcode'                  => 'lotzwoo_lactosefree_label',
                'heading_option_key'         => 'heading_lactosefree_label_field',
                'field_type'                 => 'checkbox',
                'settings_label'             => __('Als laktosefrei kennzeichnen', 'lotzapp-for-woocommerce'),
                'settings_description'       => __('Blendet ein Ja/Nein-Laktosefrei-Label ein.', 'lotzapp-for-woocommerce'),
                'product_field_label'        => __('Als laktosefrei kennzeichnen', 'lotzapp-for-woocommerce'),
