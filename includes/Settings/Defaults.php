...
class Defaults
{
    public function all(): array
    {
        $defaults = [
            ...
            'product_succession_enabled'              => 0,
            'product_succession_same_category_only'   => 0,
            'product_succession_unpaid_as_reserved'   => 0,
            'stock_notifications_enabled'             => 0,
            'delivery_times'           => [],
            'locked_fields'            => [],
            ...
            'emails_advanced_editing_enabled' => 0,
            'deposit_enabled'          => 0,
